...
export default function Terms() {
  return (
    <div className="overflow-hidden bg-primary px-6 py-16 lg:px-8 xl:py-36">
        ...
        <div className="relative z-10 mb-8 md:mb-2 md:px-6">
          <div className="max-w-prose text-base lg:max-w-none">
            ...
            <p className="mt-2 text-3xl font-bold leading-8 tracking-tight text-foreground sm:text-4xl">
              Terms and Conditions for The Joyful Mode
            </p>
            <div>
              <p className="mt-2">
                Last updated:{" "}
        ...
        <div className="relative">
          <div className="relative md:bg-primary md:p-6">
            <div className="size-full">
              <div className="prose prose-lg prose-indigo text-foreground lg:max-w-none">
                <p>
                ...
                <ul className="marker:text-foreground">
                  ...
                  <li>
                    <p>
                      ...
                      Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                      &quot;Our&quot; in this Agreement) refers to The Joyful
                      Mode, 10503 W 33rd ct, Hialeah FL 33018.
                    </p>
                  </li>
                  <li>
                    <p>
                  ...
                  <li>
                    <p>
                      <strong>Website</strong> refers to The Joyful Mode,
                      accessible from{" "}
                      <Link href="https://www.thejoyfulmode.com">
                        https://www.thejoyfulmode.com
                      </Link>
                    </p>
                  </li>
                  <li>
